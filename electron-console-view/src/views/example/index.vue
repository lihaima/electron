				...
				tableInfo: {
					...
					events: {
						...
						delete: row => {
							...
							this.$confirm('确定删除该实例？', '操作确认', {confirmButtonText: '确定', cancelButtonText: '取消', type: 'warning'}).then(() => {
								// Todo: 事件操作
						...
						items: [
							{
								...
								rules: [{ required: true, message: '请输入实例id', trigger: 'blur' }]
							},
							{
								props: 'oiName',
								type: 'input',
							...
							},
							{
								...
								defaultValue: '', // 初始值
								attrs: {
									placeholder: '请填写实例英文名'
								},
								rules: [{ required: true, message: '请输入实例英文名', trigger: 'blur' }]
							},
							{
								props: 'oiType',
								type: 'input',
								...
								rules: [{ required: true, message: '请输入实例类型', trigger: 'blur' }]
							},
							{
								props: 'oiExplain',
								type: 'input',
								...
								rules: [{ required: true, message: '请输入实例说明', trigger: 'blur' }]
							}
						]
					},
